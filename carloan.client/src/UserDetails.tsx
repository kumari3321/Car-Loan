...
// // import {  getUserByUserId } from './apis/LoanCalculator'; 
...
// //       getUserByUserId(userIdL)
// //         .then((response) => {
// //           const userData = response.data;
// //          console.log(userData,"lloooo");
...
// //         {user.profilePhoto ? (
// //           <img src={user.profilePhoto} alt="Profile" style={{ width: 100, height: 100 }} />
// //         ) : (
...
// import { getUserByUserId, updateUsers } from './apis/LoanCalculator';
// import { Button, Form, Input, Modal, Tooltip, Upload, UploadFile, UploadProps } from 'antd';
...
//       setUser( user); // Update state with new user data
//       setIsModalVisible(false);
//     } catch (error) {
...
import { EditFilled, UploadOutlined } from "@ant-design/icons";
import { getUserByUserId, updateUsers } from './apis/LoanCalculator';
import { Button, Form, Input, Modal, notification, Tooltip, Upload, UploadFile, UploadProps } from 'antd';
